// Navbar.js
//		code to create the top navbar section
...
const Navbar = () => {
	...
	// handler for Connect button; loads the Metamask account
	const connectHandler = async () => {
		await loadAccount(provider, dispatch)
	}

	// handler for the Select Network option
	const networkHandler = async (e) => {
		// send a request to Metamask to change the network to the selected value
